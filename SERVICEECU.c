 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Aug 31 15:34:11 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                SERVICEECU
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 sensorCabineTemp
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 targetPosition
...
/* Input Port  2 */
#define IN_PORT_2_NAME                 FlapMotorPosition
...
/* Input Port  3 */
#define IN_PORT_3_NAME                 sensorSun
...
/* Input Port  4 */
#define IN_PORT_4_NAME                 blowerMotorCurrent
...
/* Input Port  5 */
#define IN_PORT_5_NAME                 sensorAirQuality
...
/* Input Port  7 */
#define IN_PORT_7_NAME                 evaporatorTemp
...
/* Input Port  8 */
#define IN_PORT_8_NAME                 fanSpeed
...
#define IN_12_ISSIGNED                 1
#define IN_12_WORDLENGTH               64
#define IN_12_FIXPOINTSCALING          0
#define IN_12_FRACTIONLENGTH           0
#define IN_12_BIAS                     0
#define IN_12_SLOPE                    0.125

/* Input Port  13 */
#define IN_PORT_13_NAME                code
#define INPUT_13_DIMS_ND               {1,1}
#define INPUT_13_NUM_ELEMS             1
#define INPUT_13_WIDTH                 1
#define INPUT_DIMS_13_COL              1
#define INPUT_13_DTYPE                 int64_T
...
#define IN_13_ISSIGNED                 1
#define IN_13_WORDLENGTH               64
#define IN_13_FIXPOINTSCALING          0
#define IN_13_FRACTIONLENGTH           0
#define IN_13_BIAS                     0
#define IN_13_SLOPE                    0.125

/* Input Port  14 */
#define IN_PORT_14_NAME                serviceId
#define INPUT_14_DIMS_ND               {1,1}
#define INPUT_14_NUM_ELEMS             1
#define INPUT_14_WIDTH                 1
#define INPUT_DIMS_14_COL              1
#define INPUT_14_DTYPE                 int64_T
...
#define IN_14_ISSIGNED                 1
#define IN_14_WORDLENGTH               64
#define IN_14_FIXPOINTSCALING          0
#define IN_14_FRACTIONLENGTH           0
#define IN_14_BIAS                     0
#define IN_14_SLOPE                    0.125
#define NUM_OUTPUTS                    2

/* Output Port  0 */
#define OUT_PORT_0_NAME                response
#define OUTPUT_0_DIMS_ND               {1,10}
#define OUTPUT_0_NUM_ELEMS             10
#define OUTPUT_0_WIDTH                 1
#define OUTPUT_DIMS_0_COL              10
#define OUTPUT_0_DTYPE                 int64_T
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                responseStatusCode
#define OUTPUT_1_DIMS_ND               {1,1}
#define OUTPUT_1_NUM_ELEMS             1
#define OUTPUT_1_WIDTH                 1
#define OUTPUT_DIMS_1_COL              1
#define OUTPUT_1_DTYPE                 int64_T
...
#define OUT_1_WORDLENGTH               64
#define OUT_1_FIXPOINTSCALING          0
#define OUT_1_FRACTIONLENGTH           0
#define OUT_1_BIAS                     0
...
extern void SERVICEECU_Outputs_wrapper(const real_T *sensorCabineTemp,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    DTypeId DataTypeId_12 = ssRegisterDataTypeInteger(
      S,
      IN_12_ISSIGNED,
      64,
      0 );
    ssSetInputPortDataType(S, 12, DataTypeId_12);
  }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    DTypeId DataTypeId_13 = ssRegisterDataTypeInteger(
      S,
      IN_13_ISSIGNED,
      64,
      0 );
    ssSetInputPortDataType(S, 13, DataTypeId_13);
  }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    DTypeId DataTypeId_14 = ssRegisterDataTypeInteger(
      S,
      IN_14_ISSIGNED,
      64,
      0 );
    ssSetInputPortDataType(S, 14, DataTypeId_14);
  }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port sensorCabineTemp of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port targetPosition of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port FlapMotorPosition of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port sensorSun of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port blowerMotorCurrent of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port sensorAirQuality of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port evaporatorSensorOpenCircuit of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port evaporatorTemp of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port fanSpeed of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port VIN of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port time of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port value of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port functionCode of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port code of S-Function SERVICEECU");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port serviceId of S-Function SERVICEECU");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    DTypeId DataTypeId_0 = ssRegisterDataTypeInteger(
      S,
      OUT_0_ISSIGNED,
      64,
      0 );
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    DTypeId DataTypeId_1 = ssRegisterDataTypeInteger(
      S,
      OUT_1_ISSIGNED,
      64,
      0 );
    ssSetOutputPortDataType(S, 1, DataTypeId_1);
  }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port response of S-Function SERVICEECU");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port responseStatusCode of S-Function SERVICEECU");
      return;
    }
...
{
  const real_T *sensorCabineTemp = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *targetPosition = (real_T *) ssGetInputPortRealSignal(S, 1);
  const real_T *FlapMotorPosition = (real_T *) ssGetInputPortRealSignal(S, 2);
  const real_T *sensorSun = (real_T *) ssGetInputPortRealSignal(S, 3);
  const real_T *blowerMotorCurrent = (real_T *) ssGetInputPortRealSignal(S, 4);
  const real_T *sensorAirQuality = (real_T *) ssGetInputPortRealSignal(S, 5);
  const int32_T *evaporatorSensorOpenCircuit = (int32_T *)
    ssGetInputPortRealSignal(S, 6);
  const real_T *evaporatorTemp = (real_T *) ssGetInputPortRealSignal(S, 7);
  const real_T *fanSpeed = (real_T *) ssGetInputPortRealSignal(S, 8);
  const int32_T *VIN = (int32_T *) ssGetInputPortRealSignal(S, 9);
  const real_T *time = (real_T *) ssGetInputPortRealSignal(S, 10);
  const real_T *value = (real_T *) ssGetInputPortRealSignal(S, 11);
  const int64_T *functionCode = (int64_T *) ssGetInputPortSignal(S, 12);
  const int64_T *code = (int64_T *) ssGetInputPortSignal(S, 13);
  const int64_T *serviceId = (int64_T *) ssGetInputPortSignal(S, 14);
  int64_T *response = (int64_T *) ssGetOutputPortSignal(S, 0);
  int64_T *responseStatusCode = (int64_T *) ssGetOutputPortSignal(S, 1);
  SERVICEECU_Outputs_wrapper(sensorCabineTemp, targetPosition, FlapMotorPosition,
    sensorSun, blowerMotorCurrent, sensorAirQuality, evaporatorSensorOpenCircuit,
    evaporatorTemp, fanSpeed, VIN, time, value, functionCode, code, serviceId,
